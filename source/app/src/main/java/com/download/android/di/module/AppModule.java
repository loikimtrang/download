...
import com.download.android.BuildConfig;
import com.download.android.constant.Constants;
import com.download.android.data.AppRepository;
import com.download.android.data.Repository;
import com.download.android.data.local.prefs.AppPreferencesService;
import com.download.android.data.local.prefs.PreferencesService;
import com.download.android.data.local.room.AppDatabase;
import com.download.android.data.local.room.AppDbService;
import com.download.android.data.local.room.RoomService;
import com.download.android.data.remote.ApiService;
import com.download.android.data.remote.AuthInterceptor;
import com.download.android.di.qualifier.ApiInfo;
import com.download.android.di.qualifier.DatabaseInfo;
import com.download.android.di.qualifier.PreferenceInfo;
