...
-keepclassmembers class * extends com.download.android.data.model.api.request.BaseRequest { *;}
-keep class com.pos.android.data.model.api.response.BaseResponse**
-keepclassmembers class * extends com.download.android.data.model.api.response.BaseResponse { *;}